...
<nav class="navbar navbar-inverse">
    <div class="heading-div col-md-7 col-sm-7">
        <h3 style="font-size: 30px;font-weight: bolder">Enter Your Personal Information</h3>
                        ...
                        <form id="myform" method="post" action="sms_verify.php" class="form-horizontal" role="form">
                            <div class="form-group col-md-12">
                                <div class="form-group col-sm-6 section">
                                    ...
                                    <input class="form-control" type="text" maxlength="50" name="student_name"
                                           id="student_name"
                            ...
                            <div class="form-group col-md-12 section">
                                <div class="form-group col-sm-6 section">
                                    ...
                                    <input class="form-control" value="" type="email" name="email_address" id="email_address"
